...
def generate_launch_description():
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        parameters=[{'robot_description': robot_description_content, 'frame_prefix': robot_namespace}],
    ...
    return LaunchDescription(declared_arguments + [relayboard, start_robot_state_publisher_cmd, laser, kinematics, teleop, relay_topic_lidar1, relay_topic_lidar2])