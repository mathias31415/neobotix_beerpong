 ...
 * Purpose : Provides the ROS2-Service client "MoveToPoseLinSrv"
 *
...
public:
    ...
    MoveArmToPoseLin(const std::string &name, const BT::NodeConfiguration &config) : RosService(name, config) {}
